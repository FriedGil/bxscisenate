<script>
    import senate from '$lib/assets/senate.jpg';
    import Typewriter from 'svelte-typewriter'
</script>
<div class="hero min-h-screen" style="background-image: url({senate});">
    <div class="hero-overlay bg-opacity-60"></div>
    <div class="hero-content text-center text-neutral-content">
      <div class="max-w-md">
        <h1 class="mb-5 text-7xl font-bold text-primary">We the Students</h1>
        <p class="mb-5">
            <Typewriter interval=50 mode="loop">
                Welcome to the Bronx Science Senate website
            </Typewriter>
        </p>
      </div>
    </div>
